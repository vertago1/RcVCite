...
<h2>Change log</h2>
<p>RSS feed: <a href="rss.xml"><img height="28" width="28" src="img/feed-icon-28x28.png" style="vertical-align: middle; padding-bottom: 0.05em;"> subscribe</a></p>
<?php
...
?>
<h3><a name="<?php echo $time; ?>"></a><?php echo $header; ?></h3>
